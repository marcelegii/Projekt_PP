...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// sliceNameTextBox
			// 
			this->sliceNameTextBox->Location = System::Drawing::Point(1, 17);
			this->sliceNameTextBox->Name = L"sliceNameTextBox";
			this->sliceNameTextBox->Size = System::Drawing::Size(100, 20);
			...
			// butApplySliceName
			// 
			this->butApplySliceName->Location = System::Drawing::Point(12, 43);
			...
			this->chBoxNegative->Location = System::Drawing::Point(1, 94);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(157, 17);
			...
			this->label2->Location = System::Drawing::Point(177, 1);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(71, 130);
			...
			// butApplyScale
			// 
			this->butApplyScale->Location = System::Drawing::Point(158, 43);
			...
			// butApplyThreshold
			// 
			this->butApplyThreshold->Location = System::Drawing::Point(158, 127);
			...
			this->label4->Location = System::Drawing::Point(9, 176);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(71, 207);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(71, 233);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(71, 259);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(71, 285);
			...
			this->label5->Location = System::Drawing::Point(9, 210);
			...
			this->label6->Location = System::Drawing::Point(9, 236);
			...
			this->label7->Location = System::Drawing::Point(9, 262);
			...
			this->label8->Location = System::Drawing::Point(9, 288);
			...
			this->chBoxMode->Location = System::Drawing::Point(158, 209);
			...
			this->chBoxFast_Slow->Location = System::Drawing::Point(158, 236);
			...
			this->label9->Location = System::Drawing::Point(9, 324);
			...
			this->label10->Location = System::Drawing::Point(9, 352);
			...
			// textBox7
			// 
			this->textBox7->Location = System::Drawing::Point(71, 349);
			...
			// butApplySDA
			// 
			this->butApplySDA->Location = System::Drawing::Point(157, 282);
			...
			// butApplySize
			// 
			this->butApplySize->Location = System::Drawing::Point(158, 342);
			...
			this->ClientSize = System::Drawing::Size(519, 385);
			this->Controls->Add(this->butApplySize);
			this->Controls->Add(this->butApplySDA);
			this->Controls->Add(this->textBox7);
			this->Controls->Add(this->label10);
			this->Controls->Add(this->label9);
			this->Controls->Add(this->chBoxFast_Slow);
			this->Controls->Add(this->chBoxMode);
			...
			this->Controls->Add(this->butApplyThreshold);
			this->Controls->Add(this->butApplyScale);
			this->Controls->Add(this->label3);
			this->Controls->Add(this->textBox2);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->textBox1);
			this->Controls->Add(this->chBoxNegative);
			this->Controls->Add(this->butApplySliceName);
			this->Controls->Add(this->label1);
			this->Controls->Add(this->sliceNameTextBox);
